...
export default function RootLayout({children}: {children: React.ReactNode}) {
  return (
    <html lang="en">
      <body className="relative bg-[#0A192F] min-h-screen text-[#E0E6ED] font-sans antialiased" suppressHydrationWarning>
        {/* Scattered Shapes */}
        <div className="fixed inset-0 pointer-events-none overflow-hidden z-0 opacity-20">
          <div className="absolute top-[10%] left-[10%] w-64 h-64 bg-[#00D4FF] rounded-full mix-blend-screen filter blur-3xl animate-pulse"></div>
