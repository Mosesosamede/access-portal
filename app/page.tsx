  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-transparent text-[#E0E6ED] p-6 md:p-12">
      ...
      <div className="max-w-md text-center mb-8 bg-white/5 p-5 md:p-8 rounded-3xl border border-white/10 backdrop-blur-sm">
        ...
        <div className="mt-4 text-3xl md:text-4xl text-[#00D4FF] animate-bounce">↓</div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-4 md:gap-6 w-full sm:w-auto">
        ...
        <Link href="/access" className="px-6 py-3 md:px-8 md:py-4 bg-transparent border border-[#00D4FF] text-[#00D4FF] rounded-full font-bold text-base md:text-lg hover:bg-[#00D4FF] hover:text-[#0A192F] transition-all text-center">
          Start Your Journey
        </Link>
      </div>
    </main>
